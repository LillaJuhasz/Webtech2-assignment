...
mongoimport --host $MONGO_HOST_IP --db shutter-shop --collection shutterDatabase shutterDatabase.json
mongoimport --host $MONGO_HOST_IP --db shutter-shop --collection customerDatabase customerDatabase.json
mongoimport --host $MONGO_HOST_IP --db shutter-shop --collection workerDatabase workerDatabase.json
mongoimport --host $MONGO_HOST_IP --db shutter-shop --collection orderDatabase orderDatabase.json
